...
<div class="row">
		@if($event)
		<form class="col-lg-6 offset-lg-4" method="POST" enctype="multipart/form-data" action="{{route('admin.update.event')}}">
			{{ csrf_field() }}
		...
		@else
		<form class="col-lg-6 offset-lg-4" method="POST" enctype="multipart/form-data" action="{{route('admin.save.event')}}">
			{{ csrf_field() }}
			<h3 class="label-primary text-center">Publier un evenement</h3>
			<hr/>
			<div class="form-group">
